              ...
              <nav class="navbar navbar-expand-lg nav-line-active nav-dark nav-primary-hover">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                  <ul class="navbar-nav w-100">
                    ...
                    <li class="nav-item dropdown">
                      <a class="nav-link dropdown-toggle" href="gallery.php">Products</a>
                      <ul class="dropdown-menu">
                        <li><a class="dropdown-item" href="gallery.php">Classic Gallery</a></li>
                        <li><a class="dropdown-item" href="gallery-simple.php">Simple
                            Gallery</a></li>
                      </ul>
                    </li>
                    <li class="nav-item dropdown">
                      <a class="nav-link dropdown-toggle" href="CompanyProfile.php">Company
                        Profile</a>
                    </li>
                    <li class="nav-item">
